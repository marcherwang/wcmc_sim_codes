%function fec64QamSuccessRate: calculate the success rate of a packet transmitted in the FEC 64QAM modulation scheme at the given SINR.
...
function y = fec64QamSuccessRate (sinr, unit, nbits, bValue)
    ber = sixtyFourQamBer(sinr, unit);
    if ber == 0.0
        y=1.0;  
        return;
    end
